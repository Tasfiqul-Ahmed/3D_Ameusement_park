...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Tasfiqul Ahmed - GRAPHICS PROJECT", NULL, NULL);
    if (window == NULL)
    {
    ...
    string facesCubemapNight[6] = {
        "images/night_right.jpeg",
        "images/night_left.jpeg",
        "images/night_top.jpeg",
        "images/night_bottom.jpeg",
        "images/night_front.jpeg",
        "images/night_back.jpeg"
    };
    ...
    load_texture(texture1, "images/grass_2.png", GL_RGBA);
    load_texture(texture2, "images/brickwall_1.jpg", GL_RGB);
    load_texture(texture3, "images/brickwall_2.jpg", GL_RGB);
    load_texture(texture4, "images/road.jpg", GL_RGB);
    load_texture(texture5, "images/concrete1.png", GL_RGBA);
    load_texture(texture6, "images/concrete2.png", GL_RGBA);
    load_texture(texture7, "images/concrete3.png", GL_RGBA);
    load_texture(texture8, "images/leather.png", GL_RGBA);
    load_texture(texture9, "images/leather2.png", GL_RGBA);
